  ...
  <!--Start Dashboard Content-->
	<div class="row">
	 <div class="col-12 col-lg-12">
	   <div class="card">
	     <div class="card-header"><center>menu Table</center>
       <a href="menu_insert.php"><button type="button" class="btn btn-success">Add Menu</button></a>
		  <div class="card-action">
        <?php
          $selreg="select * from menu";
...
{$i++;
                   ...
                   <tbody><tr>
                    ...
                    <td>$row[7]</td>
                    <td>$row[8]</td>
                    <td><a href='menu_delete.php?id=$row[0]'><button type='button' class='btn btn-danger'><i class='fa fa-trash'></i></button></a>
                    <td><a href='menu_update.php?id=$row[0]'><button type='button' class='btn btn-warning'><i class='fa fa-pencil'></i></button></a>"
                    ;} ?>
