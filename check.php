...
<!-- Start wrapper-->
  ...
  <!--Start Dashboard Content-->
	<div class="row">
	 <div class="col-12 col-lg-12">
	   <div class="card">
	     <div class="card-header"><center>Check Table</center>
       <a href="check_form.php"><button type="button" class="btn btn-success">Check in</button></a>
		  <div class="card-action">
        <?php
          $selreg="select * from check1";
 ...
 $query = "SELECT *FROM check1 LIMIT " . $page_first_result . ',' . $results_per_page;  
 $result = mysqli_query($con, $query);  
?>
...
{$i++;
                   ...
                   <tbody><tr>
                    ...
                    <td>$row[4]</td>
                    <td>$row[5]</td>
                    <td><a href='check_del.php?id=$row[0]'><button type='button' class='btn btn-outline-warning'>Checked out</button></a></td>"
                    ;} ?>
