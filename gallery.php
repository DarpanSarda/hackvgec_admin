...
{$i++;
                   ...
                   <tbody><tr>
                    <td>'.$i.'</td>
                    <td><img src="assets/images/login/'.$row[1].'" class="product-img" alt="product img"></td>
                    <td>'.$row[2].'</td>
                    <td>'.$row[3].'</td>
                   </tr>';} ?>
 ...
 <nav aria-label="...">
  ...
  for($page = 1; $page<= $number_of_page; $page++) {  
    ...
    <li class="page-item"><a class="page-link" href = "gallery.php?page=' . $page . '">' . $page . ' </a></li>
    ';}
    ?>
  </ul>
</nav>
