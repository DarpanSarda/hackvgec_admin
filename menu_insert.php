	...
	<div class="row">
	 <div class="col-12 col-lg-12">
       ...
       <div class="card-title text-uppercase text-center py-3">Canteen menu</div>
		    <form action="menu_ins.php" method="POST" autocomplete="">
			  <div>
...
<div class="form-group">
    ...
    <input type="text" name="item1" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">item 2</label>
    <input type="text" name="item2" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">item 3</label>
    <input type="text" name="item3" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">item 4</label>
    <input type="text" name="item4" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">item 5</label>
    <input type="text" name="item5" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>

	<button type="submit" class="btn btn-light btn-block waves-effect waves-light">Submit</button>
</div>
</form>
</div>
</div>
