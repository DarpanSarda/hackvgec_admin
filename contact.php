  ...
  <!--Start Dashboard Content-->
	<div class="row">
	 <div class="col-12 col-lg-12">
	   <div class="card">
	     <div class="card-header"><center>Gallery Table</center>
...
{$i++;
                   ...
                   <tbody><tr>
                    ...
                    <td>$row[4]</td>
                    <td>$row[5]</td>
                    <td><a href='feed_res.php?id=$row[0]'><button type='button' class='btn btn-warning'><i class='fa fa-pencil'></i></button></a>
                    </tr>";} ?>
 ...
 <nav aria-label="...">
  ...
  for($page = 1; $page<= $number_of_page; $page++) {  
    echo '
    <li class="page-item"><a class="page-link" href = "contact.php?page=' . $page . '">' . $page . ' </a></li>
    ';}
    ?>
  </ul>
</nav>
