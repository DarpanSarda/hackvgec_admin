  ...
  <!--Start Dashboard Content-->
	<div class="row">
	 <div class="col-12 col-lg-12">
       ...
       <div class="card-title text-uppercase text-center py-3">Check In</div>
		    <form action="check_ins.php" method="POST" autocomplete="">
              ...
              <div class="form-group">
			   <label for="exampleInputPassword" class="sr-only">Date Time</label>
			   <div class="position-relative has-icon-right">
				  <input type="datetime-local" name="dt" id="exampleInputPassword" class="form-control input-shadow">
			   </div>
</div>
			  </div>
			  
			  
			 <button type="submit" class="btn btn-light btn-block waves-effect waves-light">Check In</button>
